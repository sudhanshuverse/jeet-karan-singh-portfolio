            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20">
                ...
                <div className="lg:col-span-5 flex flex-col justify-center">
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            {/* Interactive Contact Card 1 */}
                            <a href="mailto:jeetkaran.singh395@gmail.com" className="group flex items-start gap-5 p-4 -ml-4 rounded-2xl hover:bg-slate-100 border border-transparent hover:border-slate-200 transition-all duration-500 relative overflow-hidden">
                                ...
                                <div className="flex-1">
                                    <p className="text-[10px] font-sans tracking-widest text-slate-400 uppercase mb-1">Direct Email</p>
                ...
                >
                    ...
                    >
                        ...
                        {/* Button is no longer mapped to an animation variant so it renders INSTANTLY and ALWAYS */}
                        <div className="pt-4">
                            <button
                                type="submit"
